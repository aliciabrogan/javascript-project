...
- **Delete or reset posts** to control content during the session
- **Dark Mode Toggle** that:
  - Saves theme preference across pages using LocalStorage
  - Applies consistently through navigation (Login → Blog)
- **Multi-page navigation** using simple routing
...
- User interaction handling and basic validation
...
- Persisting blog posts using LocalStorage or a database
- Backend authentication with Node.js + Express
- Blog post editing and timestamps
- Improved accessibility and validation feedback
- Refactoring UI into component-based structure
